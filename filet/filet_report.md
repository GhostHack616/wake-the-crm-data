...
|---|---|---|---|---|
| F1 | Un désabonné ne reçoit jamais un envoi : aucun opted_out ne sort avec le canal email dans la hot list. | bloquer | ✅ | 60 lignes de hot list vérifiées |
| F2 | Un churné ne porte jamais un deal ouvert non arbitré : chaque contradiction est résolue ou en file de review. | bloquer | ✅ | 80 contradictions churned/deal, toutes doivent être arbitrées ou en review |
| F3 | Un bot n'entre dans aucun score. | bloquer | ✅ | 1 bot(s) connus, 6987 personnes scorées |
